...
int ble_ll_scan_adv_decode_addr(struct ble_ll_scan_sm *scansm, uint8_t pdu_type,
                                uint8_t *rxbuf, uint8_t **addr,
                                uint8_t *addr_type, uint8_t **inita,
                                uint8_t *inita_is_rpa,
                                struct ble_mbuf_hdr *ble_hdr, int *ext_mode);

void ble_ll_scan_restart(void);
...
/* Called to get addresses from the extended advertising packet */
int ble_ll_scan_get_addr_from_ext_adv(uint8_t *rxbuf,
